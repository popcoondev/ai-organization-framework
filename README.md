...
- role result / team output / council review を first-class execution packet として扱えるようにすること
- execution lineage を CLI から inspectable にすること
- `v2.3` の operator surface を維持したまま、判断ループの中間成果物を structured artifact にすること
...
- `v2.4` scope: [docs/v2.4-release-definition.md](docs/v2.4-release-definition.md)
- `v2.4` release notes: [docs/v2.4.0-release-notes.md](docs/v2.4.0-release-notes.md)
