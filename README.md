...
現在の stable release は `v3.1.0` である。  
次の in-progress release は `v3.2.0` であり、焦点は次の状態まで到達している。

- self-hosting repo 上で backend-neutral runtime loop を 1 本 auditable proof として成立させること
- role result / role join / team output / council review / execution lineage を runtime artifact として扱えること
- governed allocation, visibility projection, learning loop を含む release-grade trace を保てること
