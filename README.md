...
- current organization / capability model を operator-usable command surface にすること
- organization / contract / dependency / decision / roadmap を CLI から inspectable にすること
- unified organization audit を first-class runtime surface にすること
...
- `v2.3` scope: [docs/v2.3-release-definition.md](docs/v2.3-release-definition.md)
- `v2.3` release notes: [docs/v2.3.0-release-notes.md](docs/v2.3.0-release-notes.md)
