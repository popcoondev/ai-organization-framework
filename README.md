...
- skill / capability / resource / policy を first-class artifact にすること
- validation / analytics / learning-loop を inspectable command surface にすること
- `v2.2` と `v3.x` の境界を明確に保つこと
...
- `v2.2` scope: [docs/v2.2-release-definition.md](docs/v2.2-release-definition.md)
- `v2.2` release notes: [docs/v2.2.0-release-notes.md](docs/v2.2.0-release-notes.md)
