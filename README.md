...
次の focus は、cadence timing / dispatch / scheduler profile を visibility contract に載せた現状を土台にして、live `.aof/` operating state から status / timeline / flow output を自動生成できるようにすることである。
