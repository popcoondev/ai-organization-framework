...
現在は `v1.10.0` までを release 済みで、repo 自体に AOF を適用する self-hosting cycle を進めている。  
次の focus は、cadence runtime と Codex orchestration を混同しない前提を保ったまま、現行 Codex 仕様で実装可能な parent/child orchestration contracts を `v1.11` candidate として固め、CI と sign-off へ進めることである。
...
- `v1.10` の境界: [docs/v1.10-release-definition.md](docs/v1.10-release-definition.md)
- `v1.11` の境界: [docs/v1.11-release-definition.md](docs/v1.11-release-definition.md)
...
- Codex parent/child orchestration model: [docs/codex-parent-child-orchestration-model.md](docs/codex-parent-child-orchestration-model.md)
