...
次の focus は、`v1.9.0` と post-release self-hosting cycle で成立した cadence runtime を土台にして、cadence timing / dispatch / scheduler profile を既存の human visibility contract から読めるようにすることである。
