...
SDK surface と adapter boundary は [docs/sdk-surface-model.md](/Users/mn/Documents/Codex/2026-05-30/ai-ai-organization-framework-ai-ai/docs/sdk-surface-model.md:1) を正本とする。
...
1. [#13 runtime と SDK の境界、および adapter surface をどう定義するか](https://github.com/popcoondev/ai-organization-framework/issues/13)
