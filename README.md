...
現在の stable release は `v5.0.0` である。
この release で、self-hosting runtime は次の状態に到達した。

- Human Recognition Interface で runtime state を operator が読めること
...
- Skillful Actor state を Human Recognition Interface へ canonical artifact から投影できること
...
- current release definition: [docs/v5.0-release-definition.md](docs/v5.0-release-definition.md)
- current release checklist: [docs/v5.0-release-checklist.md](docs/v5.0-release-checklist.md)
- current release notes: [docs/v5.0.0-release-notes.md](docs/v5.0.0-release-notes.md)
...
- `v3.0` scope: [docs/v3.0-release-definition.md](docs/v3.0-release-definition.md)
- `v3.0` release notes: [docs/v3.0.0-release-notes.md](docs/v3.0.0-release-notes.md)
- `v3.1` release definition: [docs/v3.1-release-definition.md](docs/v3.1-release-definition.md)
- `v3.1` release checklist: [docs/v3.1-release-checklist.md](docs/v3.1-release-checklist.md)
- `v3.1` release notes: [docs/v3.1.0-release-notes.md](docs/v3.1.0-release-notes.md)
- `v3.2` release definition: [docs/v3.2-release-definition.md](docs/v3.2-release-definition.md)
- `v3.2` release checklist: [docs/v3.2-release-checklist.md](docs/v3.2-release-checklist.md)
- `v3.2` release notes: [docs/v3.2.0-release-notes.md](docs/v3.2.0-release-notes.md)
- `v3.3` release definition: [docs/v3.3-release-definition.md](docs/v3.3-release-definition.md)
- `v3.3` release checklist: [docs/v3.3-release-checklist.md](docs/v3.3-release-checklist.md)
- `v3.3` release notes: [docs/v3.3.0-release-notes.md](docs/v3.3.0-release-notes.md)
- `v3.4` release definition: [docs/v3.4-release-definition.md](docs/v3.4-release-definition.md)
- `v3.4` release checklist: [docs/v3.4-release-checklist.md](docs/v3.4-release-checklist.md)
- `v3.4` release notes: [docs/v3.4.0-release-notes.md](docs/v3.4.0-release-notes.md)
