...
5. `run -> answer -> signal(reopen)` の external-signal reopen path

これにより、CI で planning / proposal / review / approval に加えて、fast-track と deep-path の routing 差分、human escalation lifecycle の 3 分岐、external change reopen も拾える。
