...
また、prototype には preflight と planning execution、必要なら proposal/review/approval execution、さらに signal reopen からの resume execution までまとめて回す `live-verify` command を持たせる。
