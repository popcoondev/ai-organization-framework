...
これにより、CI で planning / proposal / review / approval に加えて、fast-track と deep-path の routing 差分、human escalation lifecycle の 3 分岐、external change reopen、そして reopen 後の workflow resume も拾える。
