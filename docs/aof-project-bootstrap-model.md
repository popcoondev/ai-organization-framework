...
- spec/runtime source:
  - `https://github.com/popcoondev/ai-organization-framework/tree/v2.4.0`
- operational install source:
  - `git clone --branch v2.4.0 https://github.com/popcoondev/ai-organization-framework.git`
...
```json
{
  ...
  "skills_ref": ".aof/skills.json",
  "capability_registry_ref": ".aof/capability-registry.json",
  "resource_inventory_ref": ".aof/resource-inventory.json",
  "policy_ref": ".aof/policies.json",
  "goals_ref": ".aof/goals",
  "tasks_ref": ".aof/tasks",
