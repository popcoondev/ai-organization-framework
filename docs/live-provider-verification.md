...
さらに `verification-archive-index.json` と `verification-archive-index.md` も生成され、retained count、retention reached、latest archived run、provider/workflow mix、current recommendation を compact に読める。
