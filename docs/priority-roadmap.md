...
- Human-started parent Codex orchestration
...
`v1.11` の Codex orchestration formalization と完了条件は [docs/v1.11-release-definition.md](docs/v1.11-release-definition.md) を正本とする。
