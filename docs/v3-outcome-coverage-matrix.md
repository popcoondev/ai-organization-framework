...
| Vanity success | 局所 KPI は良いが本質価値がない | `OC-003` | runtime-generated verdict exists | add complementary observed-metric-but-weak-value families | P1 |
...
5. `OC-003` は runtime-generated proxy-metric contrast case まで前進した
6. 残る gap は complementary observed-metric weak-value families と `OC-004` fail-to-improve families である

## Required Next Moves

1. `OC-003` に observed metric movement but weak value-correlation family を追加する
