...
2. `RV-004` の recorded coverage が未完了であり、`RV-003` は fixture-level verdict まで前進した
...
1. `RV-004` の multi-loop verdict を保存し、`RV-003` は runtime-generated before/after pairs に広げる
